...
class _CrearRecetaWidgetState extends State<CrearRecetaWidget> {
  ...
  void initState() {
    ...
    _model.nombreRecetaController ??= TextEditingController();
    _model.porcionesController ??= TextEditingController();
    _model.ingredientesController ??= TextEditingController();
    _model.procedimientoController ??= TextEditingController();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<CategoriasRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CategoriasRecord> crearRecetaCategoriasRecordList = snapshot.data!;
