    ...
    return StreamBuilder<List<CategoriasRecord>>(
      stream: queryCategoriasRecord(
        queryBuilder: (categoriasRecord) =>
            categoriasRecord.where('categoria', isEqualTo: widget.nomCategoria),
        singleRecord: true,
      ),
                                ...
                                Padding(
                                  ...
                                  child: TextFormField(
                                    controller: _model.idCategoriaController ??=
                                      ...
                                      text: editarCategoriaCategoriasRecord!
                                          .idCategoria,
                                    ),
                                    autofocus: true,
                                    obscureText: false,
                                    ...
                                    validator: _model
                                        .idCategoriaControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                                Padding(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.nombreCategoriaController ??=
                                            TextEditingController(
                                      text: editarCategoriaCategoriasRecord!
                                          .categoria,
                                    ),
                                ...
                                child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: InkWell(
                                        ...
                                        await Navigator.push(
                                          ...
                                          PageTransition(
                                            ...
                                            child: FlutterFlowExpandedImageView(
                                              image: Image.network(
                                                editarCategoriaCategoriasRecord!
                                                    .imagenCategoria,
                                                fit: BoxFit.contain,
                                              ),
                                              allowRotation: false,
                                      ...
                                      child: Hero(
                                        tag: editarCategoriaCategoriasRecord!
                                            .imagenCategoria,
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                final categoriasUpdateData =
                                    createCategoriasRecordData(
                                  categoria:
                                      _model.nombreCategoriaController.text,
                                  imagenCategoria: _model.uploadedFileUrl,
                                  idCategoria:
                                      _model.idCategoriaController.text,
                                );
                                await editarCategoriaCategoriasRecord!.reference
                                    .update(categoriasUpdateData);
                                await showDialog(
                                  context: context,
