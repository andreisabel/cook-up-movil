    ...
    return StreamBuilder<List<UsersRecord>>(
      stream: queryUsersRecord(
        queryBuilder: (usersRecord) =>
            usersRecord.where('email', isEqualTo: widget.usuario),
        singleRecord: true,
      ),
                        ...
                        Container(
                          ...
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                10.0, 10.0, 10.0, 10.0),
                            child: Text(
                              editarUsuarioUsersRecord!.email,
                        ...
                        Container(
                          ...
                          child: Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                15.0, 15.0, 15.0, 15.0),
                            child: TextFormField(
                              controller: _model.nombreUsuarioController ??=
                                  TextEditingController(
                                text: editarUsuarioUsersRecord!.displayName,
                              ),
                              autofocus: true,
                              obscureText: false,
                              ...
                              validator: _model.nombreUsuarioControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                        ),
                              ...
                              Padding(
                                ...
                                child: Text(
                                  dateTimeFormat('MMMEd',
                                      editarUsuarioUsersRecord!.createdTime!),
                                  style:
                                      FlutterFlowTheme.of(context).bodyMedium,
                                ),
                              ),
                            ...
                            children: [
                              ...
                              Switch.adaptive(
                                value: _model.switchValue ??=
                                    editarUsuarioUsersRecord!.admin,
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              final usersUpdateData = createUsersRecordData(
                                displayName:
                                    _model.nombreUsuarioController.text,
                                admin: _model.switchValue,
                              );
                              await editarUsuarioUsersRecord!.reference
