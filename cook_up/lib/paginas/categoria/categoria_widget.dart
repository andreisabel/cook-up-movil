...
class CategoriaWidget extends StatefulWidget {
  ...
  final DocumentReference? nomCategoria;
...
class _CategoriaWidgetState extends State<CategoriaWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<CategoriasRecord>(
      stream: CategoriasRecord.getDocument(widget.nomCategoria!),
      builder: (context, snapshot) {
        ...
        final categoriaCategoriasRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          ...
          appBar: AppBar(
            ...
            title: StreamBuilder<CategoriasRecord>(
              stream: CategoriasRecord.getDocument(widget.nomCategoria!),
              builder: (context, snapshot) {
                // Customize what your widget looks like when it's loading.
                if (!snapshot.hasData) {
                ...
                final textCategoriasRecord = snapshot.data!;
                return Text(
                  textCategoriasRecord.categoria,
                                  ...
                                  context.pushNamed(
                                    ...
                                    queryParams: {
                                      'receta': serializeParam(
                                        gridViewRecetasRecord.nombreReceta,
                                        ParamType.String,
                                      ),
                                    }.withoutNulls,
                                  );
