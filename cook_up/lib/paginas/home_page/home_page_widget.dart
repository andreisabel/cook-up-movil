            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Align(
                    alignment: AlignmentDirectional(0.0, -10.75),
                        ...
                        children: [
                          Align(
                            ...
                            child: TabBar(
                              ...
                              indicatorColor: Color(0xFFF7089F),
                              tabs: [
                                Tab(
                                  text: 'Categorías',
                                ),
                                ...
                                StreamBuilder<List<CategoriasRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<CategoriasRecord>
                                        columnCategoriasRecordList =
                                        snapshot.data!;
                                    return Column(
                                      mainAxisSize: MainAxisSize.max,
                                      children: List.generate(
                                          columnCategoriasRecordList.length,
                                          (columnIndex) {
                                  ...
                                  child: StreamBuilder<List<RecetasRecord>>(
                                    stream: queryRecetasRecord(
                                      queryBuilder: (recetasRecord) =>
                                          recetasRecord.orderBy('valoracion',
                                              descending: true),
                                    ),
                                    builder: (context, snapshot) {
                                      // Customize what your widget looks like when it's loading.
                                      ...
                                      return GridView.builder(
                                        ...
                                        itemCount:
                                            gridViewRecetasRecordList.length,
